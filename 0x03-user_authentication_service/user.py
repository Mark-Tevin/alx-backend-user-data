...
class User(Base):
    ...
    Attributes:
        ...
        hashed_password (Column): Non-nullable string storing the user's hashed password.
        session_id (Column): Nullable string for user's session ID, for session management.
